...
```
User        queryLoop()       API       Compact Svc              ╎ Notes
 │              │               │            │                    ╎
 │ (turn N,     │               │            │                    ╎ Context is ~180k tokens
 │  ~180k tok)  │               │            │                    ╎
 │ "now update  │               │            │                    ╎
 │  the README" │               │            │                    ╎
 │─────────────>│               │            │                    ╎
 ...
 │          ════ ITERATION START ════       │                    ╎
 │              │               │            │                    ╎
 │              │ getMsgsAfterCompact()      │                    ╎ Messages since last compact boundary
 │              │ applyToolResultBudget()    │                    ╎ Trim oversized tool results
 │              │ appendSystemCtx()          │                    ╎
 │              │ prependUserCtx()           │                    ╎
 │              │               │            │                    ╎
 │              │ autocompact() │            │                    ╎ tokenCount > threshold → compact
 │              │ ─────────────────────────>│                    ╎
 │              │               │            │                    ╎ Calls Haiku/Sonnet to summarize
 │              │               │            │                    ╎   all messages into digest
 │              │ <── summary + tail ───────│                    ╎ Returns summary + preserved tail
 │              │               │            │                    ╎
 │              │ buildPostCompactMsgs()    │                    ╎ Rebuilds message array:
 │              │ ───────┐      │            │                    ╎   compact_boundary_message
 │              │ <──────┘      │            │                    ╎   summary attachment (digest)
 │              │               │            │                    ╎   re-injected: memory, skills, MCP
 │              │               │            │                    ╎   preserved recent msgs (tail)
 │              │               │            │                    ╎
 │              │ ── API call ─>│            │                    ╎ msgs: [ctx, compact_summary,
 │              │               │            │                    ╎   memory_reinject, skill_reinject,
 │              │               │            │                    ╎   ...preserved_tail, user_msg]
 │              │               │            │                    ╎
 │              │ <── response ─│            │                    ╎ Text only
 │              │               │            │                    ╎
 │ "Updated     │               │            │                    ╎

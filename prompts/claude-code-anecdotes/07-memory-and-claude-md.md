...
```
User        queryLoop()    getUserCtx()  getSystemPrompt()  MemPrefetch  ╎ Notes
 │              │               │              │               │          ╎
 │ "refactor    │               │              │               │          ╎
 │  the auth    │               │              │               │          ╎
 │  module"     │               │              │               │          ╎
 ...
 │              │               │              │               │          ╎
 │              │ getUserCtx() >│              │               │          ╎ Reads CLAUDE.md files:
 │              │ <── context ──│              │               │          ╎   .claude/CLAUDE.md (project)
 │              │               │              │               │          ╎   ~/.claude/CLAUDE.md (user)
 │              │               │              │               │          ╎ Returns: { claudeMd, currentDate }
 │              │               │              │               │          ╎
 │              │ getSystemPrompt() ─────────>│               │          ╎ Calls loadMemoryPrompt():
 │              │ <── prompt ──────────────────│               │          ╎   reads MEMORY.md (truncated 200 lines)
 │              │               │              │               │          ╎   returns memory system instructions
 │              │               │              │               │          ╎
 │              │ startMemoryPrefetch() ─────────────────────>│          ╎ Async side-query: find relevant
 │              │               │              │               │          ╎   memories for "refactor auth module"
 │              │               │              │               │          ╎
 │              │ prependUserCtx()             │               │          ╎ Insert CLAUDE.md + date as msg[0]
 │              │               │              │               │          ╎
 │              │ ── API #1 ──>│              │               │          ╎
 │              │ <── response ─│              │               │          ╎ text + tool_use: Read
 │              │               │              │               │          ╎
 │              │ Read() ───────┐              │               │          ╎ Read auth module file
 │              │ <─────────────┘              │               │          ╎
 │              │               │              │               │          ╎
 │          ═══ POST-TOOL ATTACHMENT PHASE ═══                │          ╎
 │              │               │              │               │          ╎
 │              │ getAttachments()             │               │          ╎ Standard attachments
 │              │               │              │               │          ╎
 │              │ consumePrefetch() ──────────────────────────>│          ╎ Prefetch settled? Yes →
 │              │ <── relevant memories ──────────────────────<│          ╎   returns matching memory files
 │              │               │              │               │          ╎
 │              │ filterDupMemory()            │               │          ╎ Remove memories for files already
 │              │ ───────┐      │              │               │          ╎   Read/Edited this turn
 │              │ <──────┘      │              │               │          ╎
 │              │               │              │               │          ╎ Creates memory attachment messages
 │              │               │              │               │          ╎   (relevant memories only)
 │              │               │              │               │          ╎
 │              │ ── API #2 ──>│              │               │          ╎ Includes memory attachments as
 │              │ <── response ─│              │               │          ╎   <system-reminder> user messages
 │              │               │              │               │          ╎
```

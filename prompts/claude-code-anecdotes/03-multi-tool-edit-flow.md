...
User        queryLoop()       API        Tools     Attach.    ╎ Notes
 ...
 │              │ normalizeMsgs() │        │          │        ╎ Clean message array
 │              │               │          │          │        ╎
 │              │ ── API #1 ──>│          │          │        ╎ msgs: [meta_ctx, user_msg]
 │              │ <── response ─│          │          │        ╎ text + tool_use: Read(src/utils.ts)
 │              │               │          │          │        ╎
 │              │ preToolHooks()│          │          │        ╎ Check hooks for "Read"
 │              │ Read() ──────────────>│          │        ╎ Read src/utils.ts
 │              │ <────────────────────<│          │        ╎ Returns file contents
 │              │ postToolHooks()        │          │        ╎
 │              │               │          │          │        ╎
 │              │ getAttachments() ──────────────>│        ╎ skill_listing, deferred_tools,
 │              │ <──────────────────────────────<│        ╎   memory prefetch, skill discovery
 │              │               │          │          │        ╎
 │          ════ ITERATION 2 ═══          │          │        ╎
 │              │               │          │          │        ╎
 │              │ normalizeMsgs() │        │          │        ╎ Attachments → <system-reminder> msgs
 │              │               │          │          │        ╎
 │              │ ── API #2 ──>│          │          │        ╎ msgs: [ctx, user, asst, tool_result,
 │              │               │          │          │        ╎   attachments]
 │              │ <── response ─│          │          │        ╎ text + tool_use: Edit(old→new)
 │              │               │          │          │        ╎
 │              │ preToolHooks()│          │          │        ╎ Check hooks for "Edit"
 │              │ Edit() ──────────────>│          │        ╎ Replace pricee → price
 │              │ <── success ─────────<│          │        ╎
 │              │ postToolHooks()        │          │        ╎
 │              │               │          │          │        ╎
 │              │ getAttachments() ──────────────>│        ╎ edited_text_file notification
 │              │ <──────────────────────────────<│        ╎   (file watcher detected change)
 │              │               │          │          │        ╎
 │          ════ ITERATION 3 ═══          │          │        ╎
 │              │               │          │          │        ╎
 │              │ normalizeMsgs() │        │          │        ╎ edit notification → <system-reminder>
 │              │               │          │          │        ╎
 │              │ ── API #3 ──>│          │          │        ╎ Full accumulated msg history
 │              │ <── response ─│          │          │        ╎ text + tool_use: Bash("npm test")
 │              │               │          │          │        ╎
 │              │ preToolHooks()│          │          │        ╎ No pre-hook matcher for Bash

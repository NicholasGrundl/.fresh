---
description: Selects and implements the next logical task(s) from SESSION-TASKS.md
allowed-tools: [
  "Bash(git:*)",
  "Bash(grep:*)",
  "Bash(ls:*)",
...
- Check current tasks: `grep -c "\- \[ \]" SESSION-TASKS.md`
- List project structure: `ls -la`

## Your Task

Select and implement the next logical task(s) from SESSION-TASKS.md with focused execution.

## Workflow

### 1. Task Analysis
- Read SESSION-TASKS.md to identify all pending work
...
- **Follow the plan** - Implement tasks as specified in SESSION-TASKS.md, don't expand scope

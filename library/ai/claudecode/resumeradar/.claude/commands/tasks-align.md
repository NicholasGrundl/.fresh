---
description: Aligns SESSION-TASKS.md with design documentation through phased implementation
allowed-tools: [
  "Read",
  "Edit", 
  "Glob"
...
Read design documentation and align SESSION-TASKS.md to implement the design through well-structured phases.
...
2. **Analyze current SESSION-TASKS.md:**
...
4. **Present analysis to user:**
   ...
   **Questions:**
   ...
   4. Should we proceed with SESSION-TASKS.md update despite design readiness concerns?
   ```

5. **Get explicit user confirmation before updating SESSION-TASKS.md:**
   - Present the proposed changes clearly
   - Ask user to explicitly confirm: "Yes, update SESSION-TASKS.md with these changes"
   - Wait for confirmation before proceeding
   - If user says no, ask what adjustments they'd like

6. **Update SESSION-TASKS.md after user confirmation:**

...
.claude/hooks/lib/git-context-full.sh \
...
.claude/hooks/lib/git-context-full.sh --macro-count 10 --micro-count 50 \
  | .claude/hooks/lib/prompt-build-macro.sh \
  | .claude/hooks/lib/llm-summarize.sh

# Quick analysis (less history)
.claude/hooks/lib/git-context-full.sh --macro-count 2 --micro-count 5 \
  | .claude/hooks/lib/prompt-build-macro.sh \
  | .claude/hooks/lib/llm-summarize.sh
```
...
The default template is at `.claude/hooks/templates/macro-commit-prompt.txt`

**Creating Custom Templates:**

1. Copy the default template:
```bash
cp .claude/hooks/templates/macro-commit-prompt.txt my-template.txt
```
...
./.claude/hooks/lib/git-context-macro.sh -n 5
```
...
```bash
ls .claude/hooks/templates/macro-commit-prompt.txt
...
- **Template:** `.claude/hooks/templates/macro-commit-prompt.txt` - Default LLM prompt template
